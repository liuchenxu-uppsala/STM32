...
void Init_IC(void){
	...
	TIM_ICInitTypeDef_Structure.TIM_ICFilter = 0xF;
	TIM_ICInitTypeDef_Structure.TIM_ICPolarity = TIM_ICPolarity_Falling;
	TIM_ICInitTypeDef_Structure.TIM_ICPrescaler = TIM_ICPSC_DIV1;
	TIM_ICInitTypeDef_Structure.TIM_ICSelection = TIM_ICSelection_IndirectTI;
	TIM_ICInit(TIM3, &TIM_ICInitTypeDef_Structure);
	
	//TIM_PWMIConfig(TIM3,&TIM_ICInitTypeDef_Structure);
